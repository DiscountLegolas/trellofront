import finnImg from "../../src/static/finn-min.png";
import bmoImg from "../../src/static/bmo-min.png";
import princessImg from "../../src/static/princess-min.png";
import jakeImg from "../../src/static/jake-min.png";
...
export const QuoteMap = authors.reduce(
  (previous, author) => ({
    ...previous,
